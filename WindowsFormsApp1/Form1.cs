...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                foreach (var item in rendezett) //rendezett nevű lista a nyereségek lista elemeinek rendezett sorrendje alapján
                {

                    sw.Write(item.Időszak);
                    sw.Write(";");
                    sw.Write(item.Nyereség);
                    sw.WriteLine();
                }
